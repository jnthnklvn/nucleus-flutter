...
const _content =
 ...
 people in the United States got on planes, marking the second day
 that more than a million people have flown since March. Nearly three
 million additional people have flown in the days since.\n\nThe high
 number of travelers speaks to a sense of pandemic fatigue that many
 people are experiencing. For some, the desire to see family is
 worth the risk of potentially getting the coronavirus while
 traveling.\r\n\r\nBut filtration is not enough.\r\n\r\nVentilation
 is just one piece of the puzzle, said Saskia Popescu, an infection
 prevention epidemiologist in Arizona. (Dr. Popescu is married to Mr.
 Popescu.) Distancing and masking are also important to mitigate
 risk, and are the other key components for keeping the coronavirus
 from spreading, whether on planes or elsewhere.
''';
